...
/* package haskull-begins-0.1.0.0 */
#ifndef VERSION_haskull_begins
#define VERSION_haskull_begins "0.1.0.0"
#endif /* VERSION_haskull_begins */
#ifndef MIN_VERSION_haskull_begins
#define MIN_VERSION_haskull_begins(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskull_begins */
...
#define CURRENT_COMPONENT_ID "haskull-begins-0.1.0.0-inplace-haskull-begins"
